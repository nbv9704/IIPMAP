...
type DashboardHeaderOneProps = {
  isActive: boolean
  setIsActive: (active: boolean) => void
}

const DashboardHeaderOne = ({ isActive, setIsActive }: DashboardHeaderOneProps) => {
      ...
      <div className="position-relative">
        ...
        <div className="logo d-md-block d-flex align-items-center justify-content-between plr bottom-line pb-30">
          <Link href="/dashboard/dashboard-index">
            <Image src={dashboardLogo} alt="IIP Dashboard" />
          </Link>
          <button
            type="button"
          ...
          <ul className="style-none">
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/dashboard-index") ? "active" : ""
                }`}
              >
                <Image
                  src={
                    isActivePath("/dashboard/dashboard-index")
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/message") ? "active" : ""
                }`}
              >
                <Image
                  src={isActivePath("/dashboard/message") ? dashboardIconActive_2 : dashboardIcon_2}
                  alt=""
                />
                <span>Message</span>
              </Link>
            ...
            <li className="bottom-line pt-30 lg-pt-20 mb-40 lg-mb-30" />
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/profile") ? "active" : ""
                }`}
              >
                <Image
                  src={isActivePath("/dashboard/profile") ? dashboardIconActive_3 : dashboardIcon_3}
                  alt=""
                />
                <span>Profile</span>
              </Link>
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/account-settings") ? "active" : ""
                }`}
              >
                <Image
                  src={
                    isActivePath("/dashboard/account-settings")
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/membership") ? "active" : ""
                }`}
              >
                <Image
                  src={
                    isActivePath("/dashboard/membership")
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/properties-list") ? "active" : ""
                }`}
              >
                <Image
                  src={
                    isActivePath("/dashboard/properties-list")
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/add-property") ? "active" : ""
                }`}
              >
                <Image
                  src={
                    isActivePath("/dashboard/add-property")
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/favourites") ? "active" : ""
                }`}
              >
                <Image
                  src={
                    isActivePath("/dashboard/favourites")
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/saved-search") ? "active" : ""
                }`}
              >
                <Image
                  src={
                    isActivePath("/dashboard/saved-search")
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  isActivePath("/dashboard/review") ? "active" : ""
                }`}
              >
                <Image
                  src={
                    isActivePath("/dashboard/review")
        ...
        <div className="profile-complete-status bottom-line pb-35 plr">
          ...
          <div className="progress-line position-relative">
            <div className="inner-line" style={{ width: "80%" }} />
          </div>
