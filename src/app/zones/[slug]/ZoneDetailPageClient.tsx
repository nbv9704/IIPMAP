...
import { getZoneBySlug, getAllZones } from "@/data/ZonesDataMultilang"
...
interface ZoneDetailPageClientProps {
  params: ZonePageParams
}

const ZoneDetailPageClient = ({ params }: ZoneDetailPageClientProps) => {
      ...
      <div className={styles.container}>
        ...
        <section className={styles.heroSection}>
          <div className={styles.heroImageContainer}>
            <Image src={images[currentImageIndex]} alt={zone.name} width={949} height={373} />
            ...
            <div className={styles.carouselDots}>
              {images.map((_, index) => (
                <button key={index} className={index === currentImageIndex ? styles.active : ""} onClick={() => setCurrentImageIndex(index)} />
              ))}
            </div>
          </div>
        ...
        <div className={styles.mainContainer}>
          ...
          <div className={styles.contentArea}>
            ...
            <section className={styles.detailInfo}>
              ...
              <div className={styles.detailContent}>
                <p>
                  <strong>{getTranslation(currentLang, "zoneDetail.detail.address")}:</strong> {zone.address}
                </p>
                <p>
                  <strong>{getTranslation(currentLang, "zoneDetail.detail.operatingTime")}:</strong> {zone.timeline}
                </p>
                <p>
                  <strong>{getTranslation(currentLang, "zoneDetail.detail.totalArea")}:</strong> {zone.area}
                </p>
                <p>
                  <strong>{getTranslation(currentLang, "zoneDetail.detail.landPrice")}:</strong> {zone.price}{" "}
                  {getTranslation(currentLang, "zoneDetail.detail.vatNote")}
                </p>
                <p>
            ...
            <section className={styles.mapSection}>
              <div className={styles.mapPlaceholder}>{getTranslation(currentLang, "zoneDetail.map.placeholder")}</div>
            </section>
          </div>
          ...
          <section className={styles.nearbyZones}>
            <h2>
              {getTranslation(currentLang, "zoneDetail.nearby.title")} {getTranslation(currentLang, "zoneDetail.nearby.count")}
            </h2>
...
export default ZoneDetailPageClient
